...
@AndroidEntryPoint
class KLVWallpaperServiceLock : WallpaperService() {
    ...
    override fun onCreateEngine(): Engine {
        serviceScope.launch { prefs.setLockServiceActivated(true) }
        return KLVWallpaperEngineLock()
    }

    override fun onDestroy() {
        super.onDestroy()
        serviceScope.launch { prefs.setLockServiceActivated(false) }
        serviceScope.cancel()
    }

    inner class KLVWallpaperEngineLock : Engine() {
        ...
        override fun onSurfaceCreated(holder: SurfaceHolder) {
            ...
            prefs.lockWallpaperIsLightCache.value?.let { isLight ->
            ...
            scope.launch {
                try {
                    ...
                    if (result != null) {
                        ...
                        prefs.setLockWallpaperIsLightCache(isLight)
                    }
        ...
        private fun startCollecting(holder: SurfaceHolder) {
            ...
            collectorJob = scope.launch {
                prefs.lockWallpaperState.collect { (uri, isVid) ->
                    try {
                        release()
